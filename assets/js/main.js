function calculate(){
  ...
  //console.log("Filing State: " + filingStatus);
  ...
  //console.log("Residential ZipCode: " + residentialZipcode);

  // Employment Zipcode
  var employmentZipcode = document.getElementById("employmentZipcode").value;
  //console.log("Employment ZipCode: " + employmentZipcode);

  // Employment Status
  var employmentStatus = document.getElementById("employmentStatus").value;
  //console.log("Employment Status: " + employmentStatus);

  if (income >= 0.01 && income != ""){

    /* =============================================================================
        OASDI WITHHOLDINGS CALCULATIONS
    ============================================================================= */

    // var oasdi = OASDI Withholdings

    if (filingYear == "2017" || filingYear == "2016"){
      var oasdi = "2017 OASDI Calculation: $" + income * 0.153;
    } else {
      var oasdi = "Unable to Calculate OASDI Withholdings";
    };
    ...
    // var localIncomeTax
    if(stateOfResidence == "Michigan" || stateOfEmployment == "Michigan"){
      var localIncomeTax = "Local Income Tax Calculation";
    } else {
      var localIncomeTax = "Unable to Calculate Local Income Tax";
    };

    console.log(localIncomeTax);

  } else if (income == 0 && income != "") {
    console.log("Your Income cannot equal 0. Please provide an Income for Calculations.");
  } else if (income < 0) {
    console.log("Your Income cannot be negative. Please provide an Income for Calculations.");
  } else {
    console.log("Please provide an Income for Calculations.");
  };
  ...
  // var resultsWrapper = document.createElement("p");
  // var resultsText = "Hello, " + name + "! Here are your Income Tax Results:"
  // var textNode = document.createTextNode(resultsText);
  // resultsWrapper.appendChild(textNode);
  // document.getElementById("results").appendChild(resultsWrapper);
